...
sp_cmaps  = {
        ...
        'gpt2-top-4-it' : ('chocolate', 'royalblue'),
        'gpt2-it-surprisal' : ('chocolate', 'royalblue'),
        'llama-3b-it-surprisal' : ('chocolate', 'royalblue'),
          }
                    ...
                    for space in [
                        ...
                        for time in [
                            ...
                            for model in [
                                          ...
                                          'gpt2-it-surprisal',
                                          'llama-3b-it-surprisal',
                                          'llama-1b-it-surprisal',
                                          #'llama-1b-top-4-it',
